...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner == address(newOwner),"Adress provided is not valid");
        _owner = newOwner;
    }
}
...
contract Pausable is Ownable {
    ...
    modifier whenNotPaused () {
        require(_paused == false, "Smart contract need to be unpaused to run this action");
        _;
    }

    modifier paused () {
        require(_paused == true, "Smart contract need to be paused to run this action");
        _;
    }
}
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(ownerOf(tokenId) != to, "Address musn't be the current token holder");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require((getOwner() == msg.sender )|| isApprovedForAll(ownerOf(tokenId), to), "Caller must be contract owner or isApprovedForAll must be true");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(address(to) != address(0), "Address need to be valid / not zero address"); 
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(_tokenOwner[tokenId] == msg.sender, "Caller must be the owner of the token");
        // TODO: require token is being transfered to valid address
        require(address(to) != address(0), "Address must be valid");
        // TODO: clear approval
